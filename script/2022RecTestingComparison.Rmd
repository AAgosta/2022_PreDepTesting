---
title: "Receiver testing comparison"
...
knitr::opts_knit$set(root.dir = 'C:/Users/mandi/Documents/GitHub/2022_PreDepTesting')
#used this to set up my working directory for all subsequent chunks
...
air1_filter <- air1_df$location <- "Air"
...
```{r}
#####receiver 2015-6005
air2 <- read.csv("data/air/156005_220106_150701_P - Copy.csv")
#air1_fill <- air1 [-c(1:7), ] # removed the top 7 rows that had information I did not need but did not renumber the rows
...
```{r}
#####receiver 2015-6036
air3 <- read.csv("data/air/156036_220119_134143_P - Copy.csv")
#air1_fill <- air1 [-c(1:7), ] # removed the top 7 rows that had information I did not need but did not renumber the rows
...
```{r}
#####receiver 2017-6013
air4 <- read.csv("data/air/176013_220118_074837_P - Copy.csv")
#air1_fill <- air1 [-c(1:7), ] # removed the top 7 rows that had information I did not need but did not renumber the rows
